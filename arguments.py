...
parser.add_argument("--agent", type=str, choices=["dqn", "ddqn", "dueling_ddqn", "multistep_dqn", 'prioritized_ddqn', 'distributional_dqn', 'noise_dqn', 'a3c', 'rainbow'], default="noise_dqn", help="Specify the agent type.")
